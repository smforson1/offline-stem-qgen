...
const styles = StyleSheet.create({
  ...
  content: { flex: 1, paddingHorizontal: 28, paddingTop: 20, paddingBottom: 40, justifyContent: 'space-between' },
  ...
  heroWrapper: { alignItems: 'center', justifyContent: 'center', marginTop: 40, marginBottom: 20 },
  heroCircle: { width: width * 0.5, height: width * 0.5, borderRadius: width * 0.25, backgroundColor: Colors.primarySoft, position: 'absolute' },
  heroIcon: { zIndex: 10 },

  mainHeading: { fontSize: 38, fontFamily: Fonts.extraBold, color: Colors.textPrimary, lineHeight: 46, letterSpacing: -1, marginBottom: 16 },
  accentText: { color: Colors.primary },
  subtitle: { fontSize: 15, fontFamily: Fonts.regular, color: Colors.textMuted, lineHeight: 24, marginBottom: 32 },

  features: { flexDirection: 'row', gap: 16, marginBottom: 40 },
  ...
  featureIconWrap: { width: 40, height: 40, borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
